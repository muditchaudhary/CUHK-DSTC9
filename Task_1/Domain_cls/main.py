import numpy as np
import torch
from dataset import DSTC_NLI_Dataset
import argparse
...
def load_dataset(args, split_type, tokenizer, hypothesis_template="", System_repsonse_prefix="",
    ...
    dataset = DSTC_NLI_Dataset(args,  split_type,tokenizer, hypothesis_template, System_repsonse_prefix,
                               User_response_prefix)
...
def evaluate(args, eval_dataset, model):
    ...
    eval_result = {"loss": eval_loss, "accuracy": accuracy, "micro_precision": micro_precision,
...
def main():
    ...
    train_dataset = load_dataset(args=args, split_type='train', tokenizer=tokenizer,
                                 hypothesis_template="User is asking about {}.", System_repsonse_prefix="Assistant says ",
